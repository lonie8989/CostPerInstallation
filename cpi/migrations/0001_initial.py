# Generated by Django 3.1.6 on 2021-02-22 21:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Orderdetails',
            fields=[
                ('ordernumber', models.OneToOneField(db_column='orderNumber', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='cpi.orders')),
        ...
        migrations.CreateModel(
            name='Payments',
            fields=[
                ('customernumber', models.OneToOneField(db_column='customerNumber', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='cpi.customers')),
